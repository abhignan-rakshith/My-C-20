...
int main()
{
    ...
    // Ranged based for loop are used to iterate over a collection types
    // The collection types are arrays, vectors, strings, etc.
    // The syntax is for (variable_type variable_name : collection)
