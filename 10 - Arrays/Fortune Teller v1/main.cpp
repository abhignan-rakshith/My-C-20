...
int main()
{
    ...
    char prediction7[]{"you sitting in the dark typing lots of lines of code on your fast computer"};
    ...
    std::cin.getline(name, max_length); // Get input with spaces, # charecter array
