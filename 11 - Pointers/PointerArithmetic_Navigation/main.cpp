...
int main()
{
    ...
    // scores++; // This is not allowed in c++, as the array name is a constant pointer to the first element in the array.
    int *p_score{scores};
    ...
    */
    ...
    {
        std::cout << "Value : " << *(scores + i - 1) << std::endl; // Subtract 1 because scores points to the first element.
    }
    */
