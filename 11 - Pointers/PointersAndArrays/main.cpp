...
int main()
{
    ...
    int *p_score{scores}; // This is called pointer decay
    ...
    std::cout << "p_score[0] : " << p_score[2] << std::endl;
    ...
    // The above statement is called decay to pointer, some informations is lost, hence std::size() doesn't work.
