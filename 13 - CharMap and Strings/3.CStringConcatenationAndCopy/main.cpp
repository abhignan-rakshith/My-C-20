...
// Cstring concatination and copy
// std::strcat(char *destination, const char *source), result is stored in destination
// std::strncat(char *destination, const char *source, size_t num), num is the number of characters to be copied
// std::strcpy(char *destination, const char *source), result is stored in destination
// std::strncpy(char *destination, const char *source, size_t num), num is the number of characters to be copied
