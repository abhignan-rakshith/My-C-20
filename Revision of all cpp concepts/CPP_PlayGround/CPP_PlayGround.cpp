...
int main()
{
	...
	float number1{ 1.12345678901234567890f };       // Precision : 7 // f
	double number2{ 1.12345678901234567890 };       // Precision : 15
	long double number3{ 1.12345678901234567890L }; // 15+ // L
	...
	// Precision (6 digits precision by default)
	...
	double number4{ 192400023.12 }; // REMEMBER: remove 'f' suffices
	std::cout << "number4 : " << number4 << std::endl;
	...
	double number7{ 1.924e8 }; // Can omit the lower 00023 for simplicity if our application allows that.
